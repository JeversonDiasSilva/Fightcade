...
wget https://archive.org/download/lib_20240806/lib.zip
unzip lib.zip
rm lib.zip
cd ..
wget https://github.com/mmtrt/WINE_AppImage/releases/download/continuous-staging_ge_proton/wine-staging_ge-proton_8-26-x86_64.AppImage
